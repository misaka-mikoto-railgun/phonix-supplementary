...
MAIN = [
    ...
    ("A0_Proposed(±12)", "Proposed", 1.095, 0.142, 0.929, 0.974, 1.792, 0.222, 0.891, "3-seed"),
    ("A0_Proposed(±6,orig)", "Reference", 1.442, 0.0, 0.928, 0.960, 1.941, 0.0, 0.885, "1-seed"),
    ("A2_withPrefLoss(±12)", "Ablation", 1.329, 0.454, 0.933, 0.958, 1.988, 0.380, 0.889, "3-seed"),
    ("A1_NoRoomInput", "Ablation", 2.713, 0.0, 0.845, 0.873, 4.515, 0.0, 0.757, "1-seed"),
